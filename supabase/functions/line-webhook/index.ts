...
## ✍️ กฎการจัดรูปแบบข้อความ (สำคัญมาก!):
- **แบ่งย่อหน้าให้ชัดเจน** → ใช้บรรทัดว่างคั่นระหว่างหัวข้อต่างๆ เพื่อให้อ่านง่าย
- **เว้นวรรคให้ถูกต้อง** → ใส่เว้นวรรคหลัง emoji และก่อน-หลังตัวเลข
- **จัดข้อมูลเป็นหมวดหมู่** → เช่น สรุปคำสั่งซื้อ แยกจาก วิธีชำระเงิน แยกจาก ข้อความขอบคุณ
- **ใช้ลำดับหมายเลขสำหรับรายการขั้นตอน** → เช่น 1) โอนเงิน 2) แนบสลิป 3) รอยืนยัน
- **ตัวอย่างการจัดรูปแบบที่ดี**:
  "สรุปคำสั่งซื้อ: [รายละเอียด]
  
  รบกวนแจ้งช่องทางชำระเงินนะ${particleQuestion}:
  1) โอนเงิน/PromptPay: [ข้อมูล]
  2) บัตรเครดิต: [ข้อมูล]
  
  หากโอนเงินรบกวนส่งสลิปมาทางแชทได้เลย${particleEnd}"
