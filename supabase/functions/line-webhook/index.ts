...
async function getAIResponse(
  ...
  // Determine if this is the first message of today/session (for greeting purposes)
  const isFirstInteraction = customerContext.messageCount <= 1;
  
  const customerGreeting = customerContext.isReturning && customerContext.messageCount > 1
    ...
    : 'นี่คือลูกค้าใหม่หรือผู้ที่กลับมาคุยใหม่ - ทักทายอย่างเป็นมิตรเหมือนลูกค้าใหม่';
