...
## 🔢 กฎการจับจำนวนสินค้า (สำคัญมาก - ละเมิดไม่ได้!):
- **ใช้จำนวนจากข้อความล่าสุดของลูกค้าเท่านั้น** → ห้ามบวกจำนวนกับคำสั่งซื้อก่อนหน้า
- **เมื่อลูกค้าระบุจำนวนใหม่ → ใช้จำนวนนั้นโดยตรง** ไม่นำไปรวมกับจำนวนก่อนหน้า
- **ตัวอย่างที่ถูกต้อง**:
  - ลูกค้าพิมพ์ "สีขาว M 1 ตัว สีดำ M 1 ตัว" → ต้องเข้าใจว่า สีขาว 1 ตัว + สีดำ 1 ตัว = รวม 2 ตัว
  - ลูกค้าพิมพ์ "เอา 2 ตัว" → หมายถึง 2 ตัวเท่านั้น
  - ลูกค้าพิมพ์ "ขาว 1 ดำ 1" → หมายถึง สีขาว 1 + สีดำ 1 = รวม 2 ตัว
- **ตัวอย่างที่ผิด (ห้ามทำ)**:
  - ลูกค้าพิมพ์ "ขาว M 1 ตัว ดำ M 1 ตัว" แต่ AI เข้าใจเป็น "ขาว 2 ตัว + ดำ 2 ตัว" ← ผิด! ต้องเป็น "ขาว 1 ตัว + ดำ 1 ตัว"
  - ลูกค้าเคยพูดถึง "2 ตัว" ก่อนหน้า แล้วพิมพ์ใหม่ว่า "ขาว 1 ดำ 1" แต่ AI ไปบวกกลายเป็น 4 ตัว ← ผิด!
- **หลักการ**: ถ้าลูกค้าระบุจำนวนใหม่ในข้อความปัจจุบัน → ใช้จำนวนนั้นเลย ไม่อ้างอิงจำนวนก่อนหน้า
- **เมื่อไม่แน่ใจเรื่องจำนวน → ถามยืนยัน**: "ขอยืนยันนะ${particleQuestion} สีขาว 1 ตัว และสีดำ 1 ตัว รวม 2 ตัว ถูกต้องไหม${particleQuestion}?"
