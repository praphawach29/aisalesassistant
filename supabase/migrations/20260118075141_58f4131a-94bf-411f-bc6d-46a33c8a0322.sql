-- Update notify_customer_on_status_change to use extensions schema for http_post
...
BEGIN
  ...
  -- Call the edge function using extensions.http_post (pg_net is now in extensions schema)
